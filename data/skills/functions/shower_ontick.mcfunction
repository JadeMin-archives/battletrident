...
execute as @a[nbt={Inventory: [{Slot:-106b, id: "minecraft:ender_pearl"}]}] at @s run tellraw @a {"text": "", "extra": [{"selector": "@a[tag=shower]"}, {"text":"님으로 인해 "}, {"selector": "@a[tag=showed]"}, {"text": "님의 위치가 발각됩니다!"}], "color": "red"}
