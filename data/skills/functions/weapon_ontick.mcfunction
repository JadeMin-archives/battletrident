...
execute as @e[type=minecraft:trident, nbt={inGround:true}] at @s run summon minecraft:creeper ~ ~ ~ {ignited: true, Fuse: 0, ExplosionRadius: 2, Silent: true, Invulnerable: true}
